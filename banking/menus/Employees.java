...
public class Employees extends JPanel{
    public Employees(){
        ...
        setBorder(BorderFactory.createTitledBorder((BorderFactory.createLineBorder(Color.white)),"Current Employees",TitledBorder.CENTER,TitledBorder.TOP,new Font("Futura Md BT",Font.PLAIN,14),Color.white));
        setOpaque(false);
